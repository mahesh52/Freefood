...
<div class="row mb-0">
                    <div class="col-md-12 mb-20 centered triggerAnimation animated" data-animate='fadeIn'>
                        <div class="custom-heading style-1">
                            <h3 style="color:#b20505;"><span>Our Partners</span></h3>
                            <!--<h3>FAQ's </h3>-->
...
<div class="col-md-10" style="margin-left:10%; text-align:center;">
			<div class="table" >
               <table class="table table-striped">
    <thead style="background-color:#b20505; color:white; font-weight:bold;">
      <tr>
        <th><h6 style="color:white; text-align:center;">S.No 
</h6></th>
        <th><h6 style="color:white; text-align:center;">Role 
</h6></th>
        <th ><h6 style="color:white; text-align:center;">Partner Name </h6></th>
		        <th><h6 style="color:white; text-align:center;">Location				</h6></th>
...
<div class="col-md-12 mb-20 centered triggerAnimation animated" data-animate='fadeIn'>
                        <div class="custom-heading style-1">
                            <h3 style="color:#b20505;"><span>Very soon Free Food will be launched in every state and city. We are looking for Business Partners who could join our ride.</span></h3>

                        </div><!-- .custom-heading.style-1 end -->
                    </div>

<center><a href="partner-with-us-page.php"><button class="btn btn-danger">PARTNER With US</button></a></center>
 </div>
 </div>
                </div><!-- .row end -->
            </div><!-- .container end -->

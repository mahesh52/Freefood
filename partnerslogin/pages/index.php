...
$products=mysql_num_rows(mysql_query("select * from store_vendor_products where vendor_id='$_SESSION[storevendor_loginid]' and product_id in (select guid from storeproducts )"));

		 ...
		 <div class="wrapper row-offcanvas row-offcanvas-left">
            ...
            <aside class="right-side">
                ...
                <section class="content-header">
                    <h1>
                       Products (<?php if($details['pstatus']=='Pending'){?>Update Avl Quantity if products Available<?php }else{echo "Accepted";}?>)
                        	...
                        	<tr>
                            	...
                            	<td><?php echo $m; ?></td>
                                 ...
                                 <td><?php echo $cat['name'];?></td>
                                  ...
                                  <td>
								  <?php if($details['vendor_type'] == "Food"){ ?>
								  <?php if($details['pstatus']=='Pending'){?>
		<input type="number" name="price[]" value="<?php echo $price;?>"  onBlur="return checkprice(this.value,<?php echo $sprice;?>,<?php echo $m;?>);" id="<?php echo $m;?>">
         <input type="hidden" name="product_id[]" value="<?php echo $client_count['guid'];?>">
         <input type="hidden" name="min_price[]" 
		 value="<?php echo $client_count['sprice'];?>"><?php }else{echo $price;}?>
								  <?php }else{
									   echo $price;
								  } ?>
		 </td>
                          ...
                          <?php 
						  if($details['vendor_type'] == "Food"){
						  if($details['pstatus']=='Pending' && $total>0){?>

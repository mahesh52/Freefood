            ...
            <div data-page="food" class="page no-toolbar no-navbar">
                <div class="page-content">
                    ...
                    <div class="navbarpages whitebg bottomborder">
                        ...
                        <i class="fa fa-angle-left" aria-hidden="true"></i><i class="fa fa-angle-left" aria-hidden="true"></i></a>
                            ...
                            <ul class="shop_items productnew-item">
                                ...
                                if ($_GET['search'] != '') {
                                    ...
                                    $qry = mysql_query("select * from products where subcategory='$_GET[pid]' and name LIKE '%$_GET[search]%' and FIND_IN_SET('$_COOKIE[area]',area) order by name asc");
                                     ...
                                     $pro_total = mysql_num_rows(mysql_query("select * from products where subcategory='$_GET[pid]' and FIND_IN_SET('$_COOKIE[area]',area) "));
                                     $qry = mysql_query("select * from products where subcategory='$_GET[pid]' and FIND_IN_SET('$_COOKIE[area]',area) order by name asc");
                                }
                                if ($pro_total == 0) {

...
$cartqntynew = mysql_num_rows(mysql_query("select sum(cquantity) as items from cart where session_id='$_COOKIE[sessid]' and order_id='' and pid>0"));
?>
<div class="pages">
...
?>
                    <div class="carttotal">
                        <div class="carttotal_row">
                            <div class="carttotal_left">Cart Total</div>  <div class="carttotal_right">
                             ...
                             <?php if($wat>0){?>
                            <div class="carttotal_row">
                                <div class="carttotal_left">Free Food Points</div>  <div class="carttotal_right"><i class="fa fa-inr"></i><?php echo $wat; ?>
		...
		if($wat1>=$cmn['amount'] && $wat1>0){?>
                        <div class="carttotal_row">
                                <div class="carttotal_left">Special Offer For U</div>  <div class="carttotal_right"><i class="fa fa-inr"></i><?php echo $wat1; ?>
                                <input type="radio" name="points" value="special" />
                                </div>
                    ...
                    <div class="modal-content">
                        <div class="modal-body">
                            <span><?php
                                ...
                                $str4 = new DateTime($date1 . '22:00:00');
                                ?></span>
                            <ul class="list-group text-small">
                                <li class="list-group-item">
                                    <span class="pull-left"><i class="fa fa-clock-o"></i> 7.30AM-9.30AM</span>
                                    <span class="pull-right">
                                        <input type="radio" name="delivery" value="<?php
                                        echo date('D', $date);
                                        echo ",";
                                        echo date('d-m-y', $date);
                                        ?> 7.30AM-9.30AM" class="pull-right" <?php
                                               if ($str1 < $str) {
                                                   echo "disabled";
                                               }
                                               ?>/></span>
                                ...
                                <li class="list-group-item">
                                    ...
                                    <span class="pull-right">
                                        ...
                                        echo ",";
                                        echo date('d-m-y', $date);
                                        ?> 9.30AM-12.00PM" name="delivery" class="pull-right" <?php
                                               if ($str2 < $str) {
                                                   echo "disabled";
                                               }
                                               ?>/></span>
                                ...
                                <li class="list-group-item">
                                    ...
                                    <span class="pull-right">
                                        ...
                                        echo ",";
                                        echo date('d-m-y', $date);
                                        ?> 5.00PM-7.30PM" class="pull-right" <?php
                                               if ($str3 < $str) {
                                                   echo "disabled";
                                               }
                                               ?>/></span>
                                ...
                                <li class="list-group-item">
                                    ...
                                    <span class="pull-right">
                                        ...
                                        echo ",";
                                        echo date('d-m-y', $date);
                                        ?> 7.30PM-10.00PM" class="pull-right" <?php
                                               if ($str4 < $str) {
                                                   echo "disabled";
                                               }
                                               ?>/></span>
                            ...
                            <ul class="list-group text-small">
                                <li class="list-group-item">
                                    ...
                                    <span class="pull-right">
                                        ...
                                        echo ",";
                                        echo date('d-m-y', $todate);
                                        ?> 7.30AM-9.30AM" class="pull-right" /></span>
                                    <div class="clearfix"></div>
                                </li>
                                <li class="list-group-item">
                                    <span class="pull-left"><i class="fa fa-clock-o"></i> 9.30AM-12.00PM</span>
                                    <span class="pull-right">
                                        ...
                                        echo ",";
                                        echo date('d-m-y', $todate);
                                        ?> 9.30AM-12.00PM" class="pull-right"/></span>
                                    <div class="clearfix"></div>
                                </li>
                                <li class="list-group-item">
                                    <span class="pull-left"><i class="fa fa-clock-o"></i> 5.00PM-7.30PM</span>
                                    <span class="pull-right">
                                        ...
                                        echo ",";
                                        echo date('d-m-y', $todate);
                                        ?> 5.00PM-7.30PM" class="pull-right"/></span>
                                    <div class="clearfix"></div>
                                </li>
                                <li class="list-group-item">
                                    <span class="pull-left"><i class="fa fa-clock-o"></i> 7.30PM-10.00PM</span>
                                    <span class="pull-right">
                                        <input type="radio" checked name="delivery" value="<?php
                                        echo date('D', $todate);
                                        echo ",";
                                        echo date('d-m-y', $todate);
                                        ?> 7.30PM-10.00PM" class="pull-right"/></span>
                                    <div class="clearfix"></div>
                                </li>
                            </ul>

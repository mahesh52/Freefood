        ...
        <div class="page-content">
            ...
            <div class="navbarpages whitebg bottomborder">
                ...
                <i class="fa fa-angle-left" aria-hidden="true"></i></a>
                    <span class="page-title-head">&nbsp;&nbsp;Store Categories</span></h2>
            ...
            <div id="pages_maincontent">
                ...
                <div class="page_single layout_fullwidth_padding no-white-bg">
                    ...
                    <ul class="shop_items sub-cat home-store-lists">
                        <?php
                         $qry1 = mysql_num_rows(mysql_query("select * from storecategory where guid in (select category from storeproducts where status = 'Active') and FIND_IN_SET('$_COOKIE[area]',areas) order by name asc"));
                         if($qry1 >0 ){
                        $qry = mysql_query("select * from storecategory where guid in (select category from storeproducts where status = 'Active') and FIND_IN_SET('$_COOKIE[area]',areas) order by points desc") or die('error');
                        while ($row = mysql_fetch_assoc($qry)) { ?>
                              <li>
                            <div style = "width:100%;" class="shop_thumb"><a href="store-items.php?gid=<?php echo $row['guid'];?>">

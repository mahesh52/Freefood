...
<div class="row">
    ...
    <thead >
      <tr>
        <h6 style="background-color:#b20505; color:white; padding:2%; text-align:center;"> Town Partner (TP)  Business Opportunity Details</h6>
   ...
   <tr>
        <td>EARNINGS</td>
        <td>INR 2,00,000 per Month (Tentative Projections)</td>
       </tr>
   ...
   <tr>
		...
		<li> Appoint & Train CLPs</li><br/>
		<li> Make sure all 5 CLPs  Active & Delivering Orders On Time</li><br/>
		<li> Work As CLP (During Emergency)</li>
		</td>
       </tr>
    <tr>
...
<?php } ?>
	...
	<div class="form-group">
      ...
      <input type="title" class="form-control" id="title" placeholder="Enter phone number" name="title" value="Town Partner" readonly>
    </div>
	</div>

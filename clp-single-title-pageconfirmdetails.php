...
<!-- #header-wrapper end -->
    ...
    <thead >
      <tr>
        <h6 style="background-color:#b20505; color:white; padding:2%; text-align:center;"> Cluster Partner (CLP)  Business Opportunity Details</h6>
    ...
    <tbody>
      <tr>
		...
		<li>Small office setup needed or can be operated from home</li>
		</td>
	  </tr>
      ...
      <tr>
        ...
        <td>
		<li> Marketing & sales by company</li><br/>
   ...
   <tr>
        <td>EARNINGS</td>
        <td>INR 80,000 per Month (Tentative Projections)</td>
       </tr>
	   
   <tr>
        <td>TASKS</td>
        <td>
		<li> Deliver Food /Items On Time</li><br/>
...
<?php } ?>
	...
	<div class="form-group">
      ...
      <input type="title" class="form-control" id="title" placeholder="Enter phone number" name="title" value="Cluster Partner" readonly>
    </div>
	</div>

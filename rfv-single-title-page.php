...
<div class="row">
	...
	<thead >
      <tr>
        <h6 style="background-color:#b20505; color:white; padding:2%; text-align:center;">Exclusive REGULAR FOOD VENDOR (ERFV)  BUSINESS  OPPORTUNITY DETAILS</h6>
...
<li>Can be operated from Home</li>
      ...
      <tr>
        ...
        <td><li>Assured Business of 20,00,000 Per Month (T & C Apply)</li>
<li>Kitchen Set Up & Installation</li>
<li>Raw Material Supply</li>
<li> Software Support</li></td>
        </tr>
      <tr>
        <td>INVESTMENT
</td>
 ...
 <li>3,50,000</li>
	  ...
	  <tr>
        ...
        <td><li>INR 2,00,000 Per Month (Tentative Projections)</li>
...
<li>Maintain Quality Standards</li>
        ...
        <td>Around 6 to 9 Months</td>
			...
			<a href="rfv-single-title-pageconfirmdetails.php" class="btn btn-primary active" style="color:white;">I'm Interested </a>
			<br/><br/>

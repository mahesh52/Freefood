...
<!-- #header-wrapper end -->
        ...
        <!-- .page-content start -->
        <div class="page-content custom-img-background dark thin-page-title page-title-8 mb-100 hidden-xs">
           <!-- .container end -->
...
<div class="col-sm-6">
    ...
    <thead >
      <tr>
        <h6 style="background-color:#b20505; color:white; padding:2%; text-align:center;">SELF EMPLOYED VENDOR  (SEV) BUSINESS  OPPORTUNITY DETAILS</h6>
    ...
    <tbody>
      <tr>
        ...
        <td>
<li>No Sales Target</li><br>
<li>Can be operated from Home</li>
</td>
		 </tr>
      <tr>
        <td>COMPANY SUPPORT
</td>
        <td><b><li>Assured Business From Company (Exclusive Area Rights)</li><b><br>
<li>Software Support</li><br>
<li>Call Center Support</li></td>
        </tr>
      <tr>
        <td>INVESTMENT
</td>
        <td>Small Kitchen Set Up (Around INR 1,00,000)
</td>
        </tr>
	  <tr>
        <td>EARNINGS
</td>
        <td>INR 25,000 Per Month (Tentative Projections)
   ...
   <tr>
        ...
        <td><li>Prepare Food On Time</li><br>
<li>Maintain Quality Standards</li>
        ...
        <td>Around 2 to 4 Months
			...
			<div class="col-md-6">		
			<center>
				<form class="form-inline" role="form"  action="form2.php" method="post" name="f1" onsubmit="return myFunction()">
  ...
  <div class="row" style="margin-bottom:2%;">
	...
	$result1 = mysql_query( "select * from area where area is not null and area != '' ORDER BY area");?>
                      <select class="form-control" id="area" name="area"  placeholder="Select Area">
					  <option value="">Select Area</option>
                       <?php   while($row1 = mysql_fetch_array($result1))
               {

$area= $row1['area']; ?> <option value="<?php echo $area;?>"><?php echo $area;?></option>
<?php } ?>
...
<span id="areaerr" style=" color:red;"></span>					  
	...
	<div class="row" style="margin-bottom:2%;display:none;" id="loc">
	<div class="form-group">
    <label for="pwd">Location:</label>
	<?php 
	include 'sql.php';

	$result = mysql_query( "select * from location where location is not null and location != ''  ORDER BY location");?>
                      <select class="form-control" id="location" name="location"  placeholder="Select Location">
					  <option value="">Select Location</option>
                       <?php   while($row = mysql_fetch_array($result))
               {

$location2= $row['location']; ?> <option value="<?php echo $location2;?>"><?php echo $location2;?></option>
<?php } ?>
                       
                      </select>		
					  <span id="locerr" style=" color:red;">
 </div>
	...
	<div class="row" style="margin-bottom:2%;">
	<div class="form-group">
	  <label for="title">Interested As:</label>
      <input type="title" class="form-control" id="title" placeholder="Enter phone number" name="title" value="Self Employeed Vendor" readonly>
    </div>
	</div>

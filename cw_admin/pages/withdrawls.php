					 ...
					 if($check['description']=='Town Partner'){
					  ...
					  if($check['description']=='State Partner'){
						  ...
						  $det=mysql_fetch_array(mysql_query("select * from cluster where guid='$check[userid]'"));}
                                                  if($check['description']=='Coupons Vendor'){
						  $det=mysql_fetch_array(mysql_query("select * from couponsvendor where guid='$check[userid]'"));}
					 ?>
...
@$divs=$total%$limit;
	...
	<?php
					  ...
					  if($client_count['description']=='State Partner'){
						  ...
						  if($client_count['description']=='Coupons Vendor'){
						  $det=mysql_fetch_array(mysql_query("select * from couponsvendor where guid='$client_count[userid]'"));}
								?>

        ...
        <!-- header logo: style can be found in header.less -->
		 ...
		 <div class="wrapper row-offcanvas row-offcanvas-left">
            ...
            <aside class="right-side">
				...
				<form action="clp.php" method="post" name="form1" onSubmit="return valid()">
...
<form method="get" action="clp.php"><table class="table table-responsive table-bordered">
	...
	@$totals=(int)($total/$limit) + 1;
				...
				$wat=$credit[0]-$debit[0];?>
                        	...
                        	<tr>
                               ...
                               <td><?php if($wat<$client_count['minbal']){?><font color="#FF0000"><strong>Balance : <?php echo $wat;?>/-</strong></font>
                                <?php }else{?><strong>Balance : <?php echo $wat;?>/-</strong><?php }?></td>
                                <td><a href="clp.php?action=view&guid=<?php echo $client_count['guid']; ?>"><button type="button" class="btn btn-danger">Total : <?php echo $orders;?></button></a></td>

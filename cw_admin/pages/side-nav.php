                ...
                <section class="sidebar">
                    ...
                    <ul class="sidebar-menu">
                        <li>
                            ...
                            <a href="usersnew.php">
                                <i class="fa fa-dashboard"></i> <span>Registered Users</span>
                            </a>
                        </li>
                        <li>
                            <a href="coms.php">
						...
						<li>
                            <a href="stockvendor.php">
                                <i class="fa fa-th"></i> <span>Stock Vendor</span> 
                            </a>
                        </li>
                            </ul>
                            </li>
                       ...
                       <li>
                        ...
                        <li>
                            ...
                            <a href="rawmaterials.php">
                                <i class="fa fa-th"></i> <span>Raw Materials</span> 
                            </a>
                        </li>
						<li>
                            <a href="maprawmaterialtoprod.php">
                                <i class="fa fa-th"></i> <span>Prod Quantity</span> 
                            </a>
                        </li>
						<li>
                            <a href="topups.php">
                                <i class="fa fa-th"></i> <span>Top Up</span> 
                            </a>
                        </li>
                            </ul>
                            </li>
                       ...
                       <li>
                            <a href="coupons.php">
                                <i class="fa fa-th-list"></i> <span>Coupons</span> 
                            </a>
                        </li>
                        <li>
                            <a href="couponvendors.php">
                                <i class="fa fa-th"></i> <span>Vendors</span> 
                            </a>
                        </li>
                            </ul>
						...
						<li>
                            <a href="orders.php?st=Coupons">
                                <i class="glyphicon glyphicon-random"></i> <span>Coupon Orders</span> 
                            </a>
                        </li>
                        ...
                        <li>
                            <a href="users.php">
                                <i class="fa fa-user"></i> <span>Users Statement</span> 
                            </a>
                        </li>
                         <li>
                            <a href="partners.php">

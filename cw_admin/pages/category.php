...
for($i=0;$i<count($areas);$i++)
	...
	$area = rtrim($area, ',');
mysql_query("INSERT INTO `category` (`name`,`image`,areas) VALUES ('$event','$picname','$area')");
header('location:category.php');	
}
...
for($i=0;$i<count($areas);$i++)
	...
	$area = rtrim($area, ',');
mysql_query("update `category` set `name`='$event',areas = '$area' where guid='$hidid'");
header('location:category.php');	
}
?><!DOCTYPE html>
<html>
        ...
        <!-- header logo: style can be found in header.less -->
		 ...
		 <div class="wrapper row-offcanvas row-offcanvas-left">
            ...
            <aside class="right-side">
				...
				<form action="category.php" method="post" name="form1" id="frm1" onSubmit="return valid()" enctype="multipart/form-data">
...
if($m%8==0){echo "<br>";}?>
		<label>
		<input type="checkbox" class = "checkboxarea" name="areas[]" value="<?php echo $state['guid'];?>"><?php echo $state['name'];?></label>&nbsp;
                <?php } ?>
				</td></tr>
                    <tr><td>Image</td><td>
               ...
               <tr><td colspan="2">                                                            
				...
				<form action="category.php" method="post" id="frm1"  name="form1" onSubmit="return valid()" enctype="multipart/form-data">
               <table class="table table-responsive table-bordered">
...
@$divs=$total%$limit;
	...
	@$totals=(int)($total/$limit) + 1;
                        	...
                        	<tr>
                                ...
                                <td><?php echo $client_count['name'];?></td> <td><?php  
                               ...
                               <td><?php if($client_count['image']!=''){?>
							   <img src="../../android/uploaded_files/<?php echo $client_count['image'];?>" width="100" height="100"><?php } ?>
							   </td>
...
function checkedAll (frm1) {
    ...
    var aa= document.getElementById('frm1');
     if (checked == false)
		  ...
		  var cusid_ele = document.getElementsByClassName('checkboxarea');

                   ...
                   <table class="table table-responsive table-bordered">
                    	...
                    	<thead>
                          ...
                          <tr>
                            ...
                            <th>Name</th>
                            <th>Mobile</th>
     <th>Email</th><th>Area</th><th>City</th><th>Registered On</th><th>Referred By</th>
...
@$divs=$total%$limit;
	...
	@$totals=(int)($total/$limit) + 1;
                        	...
                        	<tr>
                            	...
                            	<td><?php echo $client_count[guid]; ?></td>
                                ...
                                <td><?php echo $client_count[email];?></td>
								 ...
								 <td><?php echo $client_count[state];?></td>
								  ...
								  <td><?php echo $client_count[referred_by];?></td>
                            </tr>

...
$details=mysql_fetch_array(mysql_query("select * from statepart where guid='$_SESSION[partner_loginid]'"));
?><!DOCTYPE html>
<html>
            ...
            <aside class="right-side">
                ...
                <section class="content-header">
                    <h1>
                       ...
                       <?php 
					$state=mysql_fetch_array(mysql_query("select * from state where guid='$details[state]'"));
					$town=mysql_fetch_array(mysql_query("select * from zone where guid='$_GET[zone]'"));
					echo $state['name'];?> <small>Zonal Partners</small> > <?php echo $town['name'];?> <small>Town Partners</small> > <small>Cluster Partners</small>
...
$total=mysql_num_rows(mysql_query($select1));
	$m=1;
			...
			<?php }else if($_GET['view']!='' && $_GET['view']=='town'){
            ...
            <aside class="right-side">
                ...
                <section class="content-header">
					...
					$state=mysql_fetch_array(mysql_query("select * from state where guid='$details[state]'"));
					$town=mysql_fetch_array(mysql_query("select * from zone where guid='$_GET[zone]'"));
					echo $state['name'];?> <small>Zonal Partners</small> > <?php echo $town['name'];?> <small>Town Partners</small>
...
$query_clients="SELECT * FROM `town` where zonal='$_GET[town]' order by guid desc ";
$select1="SELECT * FROM `town` where zonal='$_GET[town]'";
$query_clients=mysql_query($query_clients);
$total=mysql_num_rows(mysql_query($select1));
	if($total>0){$m=1;
						    while($client_count = mysql_fetch_assoc($query_clients)){
                        	...
                        	<tr>
                               ...
                               <td><?php echo $client_count['name'];?></td>
                              <td><a href="zonal.php?view=clp&zone=<?php echo $zone;?>&clp=<?php echo $client_count['guid'];?>">Cluster Partners : <?php echo $chk;?></a></td>
            ...
            <aside class="right-side">
                ...
                <section class="content-header">
                    <h1>
                        <?php 
					$state=mysql_fetch_array(mysql_query("select * from state where guid='$details[state]'"));
					echo $state['name'];?> <small>Zonal Partners</small>
                   ...
                   <table class="table table-responsive table-bordered">
                        ...
                        <tbody>
                         <?php 
$query_clients="SELECT * FROM `zonal` where state='$_SESSION[partner_loginid]' order by guid desc ";
$select1="SELECT * FROM `zonal` where state='$_SESSION[partner_loginid]'";
$query_clients=mysql_query($query_clients);
$total=mysql_num_rows(mysql_query($select1));
if($total>0){
	$m=1;
						    while($client_count = mysql_fetch_assoc($query_clients)){
								...
								$chk=mysql_num_rows(mysql_query("select * from town where zonal='$client_count[guid]'"));?>
                        	...
                        	<tr>
                            	...
                            	<td><?php echo $m; ?></td>
                                 ...
                                 <td><?php echo $det['name'];?></td>
                               <td><?php echo $client_count['name'];?></td>
                              <td><a href="zonal.php?view=town&zone=<?php echo $client_count['zone'];?>&town=<?php echo $client_count['guid'];?>">Town Partners : <?php echo $chk;?></a></td>

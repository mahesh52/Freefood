...
$query_clients="SELECT * FROM `comwallet` where (date Between '$from' and '$to') and description='$description' order by guid desc  Limit $start, $limit ";
$select1="SELECT * FROM `comwallet` where (date Between '$from' and '$to') and description='$description'";	
$cmn="SELECT sum(points) FROM `comwallet` where (date Between '$from' and '$to') and description='$description'";	
}
elseif($fromdate!='' && $todate!='')
{$from=date('Y-m-d',strtotime($fromdate));$to=date('Y-m-d',strtotime($todate));
$query_clients="SELECT * FROM `comwallet` where (date Between '$from' and '$to') order by guid desc  Limit $start, $limit ";
$select1="SELECT * FROM `comwallet` where (date Between '$from' and '$to')";
$cmn="SELECT sum(points) FROM `comwallet` where (date Between '$from' and '$to')";	
}elseif($description!='')
{

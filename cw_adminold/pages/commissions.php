...
{
mysql_query("INSERT INTO `commissions` (`company` ,`state`,`zonal`,`city`,`clp`,`misc`,`date`,`burnbudget`,`amount`) VALUES ('$company','$state','$zonal','$city','$clp','$misc','$date','$burnbudget','$amount')");

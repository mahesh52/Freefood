...
mysql_query("INSERT INTO `area` (`name` ,`refid`,`food`,`store`,`state`,`zone`) VALUES ('$topic','$refid','$food','$store','$state','$zone')");
	}
...
{
mysql_query("update `area` set `name`='$topic',`refid`='$refid',`food`='$food',`store`='$store',`state`='$state',`zone`='$zone' where guid='$hidid'");
header('location:area.php');	
}
?><!DOCTYPE html>
<html>

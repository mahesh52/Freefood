...
<body>
    ...
    <section class="status-bar">
        <article>
            ...
            <div class="col-xs-10 text-small" align="center">Login</div>
            ...
            <form name="form2" method="post" action="login.php">
                <div class="col-xs-12"><br>
					<li class="list-group-item">
							  <input type="text" class="form-control" placeholder="Mobile Number / Email Id" name="mobile" required><br>
							  <input type="password" class="form-control" placeholder="Password" name="password" required><br>
                               <div class="clearfix"></div>
						  </li><br>
					<button type="submit" name="submit" value="update" class="btn btn-success col-xs-12">Submit</button><br>
                    <a href="forgot.php">Forgot Password?</a> <a href="register.php" class="pull-right">Register</a>
				</div></form>
            </div>
        </article>
    </section>

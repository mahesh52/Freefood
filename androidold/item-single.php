...
<body>
    ...
    <header>
        ...
        <div class="col-xs-1 pull-right " id="left-nav">
			<a href="javascript:void0;" class="menu-icon button-1 pull-right" style="display : none;"><i class="fa fa-align-center"></i></a>
		</div>
    ...
    <section class="status-bar">
        <article>
            <div class="col-xs-1"><a href="product.php?pid=<?php echo $prod_detail['subcategory'];?>" class="text-white"><i class="fa fa-angle-left"></i></a></div>
    ...
    <section class="content-part animsition item bg-cyan" data-animsition-in-class="fade-in-up-sm" data-animsition-out-class="fade-out-up-sm" data-animsition-in-duration="1000">
        <article>
            <div class="col-xs-12 restaurant-head no-padd"><br>
				<img src="uploaded_files/<?php echo $img['image']; ?>" width="150" class="img-responsive img-circle" />
        ...
        <article>
			<div class="col-xs-12 text-small">
				...
				<div class="col-xs-12 pull-right" style="font-size: 16px; text-align: right;">
					<div class="col-xs-4"><span class="removeproduct" id="<?php echo $prod_detail['guid'];?>"><i class="fa fa-minus-square-o pull-left" style="font-size: 30px;"></i></span></div>
					<div class="col-xs-4" align="center"><b>&nbsp;<span id="product<?php echo $prod_detail['guid'];?>"><?php if(empty($chk['guid'])){echo "0";}else{echo $chk['cquantity'];}?></span>&nbsp;</b></div>
					<div class="col-xs-4"><span class="addproduct" id="<?php echo $prod_detail['guid'];?>"><i class="fa fa-plus-square-o pull-right" style="font-size: 30px;"></i></span></div>
				</div>
				<div class="clearfix"></div><br>
				<div class="col-xs-12 no-padd pull-right" style="font-size: 16px; text-align: right;">
					<a href="checkout.php" class="btn btn-success col-xs-12"><i class="fa fa-cart-plus"></i> Checkout</a>
				</div>

...
if($total==0){header('location:welcome.php');}?><!DOCTYPE HTML>
<html>
<head>
    <meta charset="UTF-8">
	<!-- For IE -->
...
<body>
    ...
    <section class="status-bar">
        <article>
            <div class="col-xs-1"><a href="checkout.php" class="text-white"><i class="fa fa-angle-left"></i></a></div>
            <div class="col-xs-10 text-small" align="center">Place Order</div>
            <div class="col-xs-1"></div>
        </article>
    </section>
    <br /><form name="form2" method="post" action="thankyou.php">
                ...
                <div class="col-xs-12 padd-sm text-small" align="center">
                    ...
                    <ul class="list-group">
                      ...
                      <li class="list-group-item list-group-item-success">
                          ...
                          <span class="pull-right"><i calss="fa fa-int"></i> <?php echo $total_price;?></span>
                          <div class="clearfix"></div>
                      </li>
    ...
    <section>
		<article>
			<div class="cart-value">
				<span class="">Cart Value: <i class="fa fa-inr gap-top"></i> <?php echo $total_price;?></span>
				<span class="pull-right">
                <input type="hidden" name="pincode" value="<?php echo $pincode;?>">
                <input type="hidden" name="payable" value="<?php echo $total_price;?>">
                <button name="submit" type="submit" class="btn btn-success"><i class="fa fa-shopping-cart"></i> Place Order</button></span>
			</div>
		</article>
	</section>
    </form>

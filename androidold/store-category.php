...
<body>
    ...
    <div class="search" style="margin-top:-2px; display:none; position:absolute; z-index: 999999;">
             ...
             <?php 
			  ...
			  while($row=mysql_fetch_assoc($qry))
			  {
                ...
                <div class="media box">
					...
					<div class="col-xs-6"> <a href="store-items.php?gid=<?php echo $row['guid'];?>"> <img class="img-responsive" alt="64x64" src="uploaded_files/<?php echo $row['image'];?>"> </a> </div> 
				</div>
				<?php } ?>

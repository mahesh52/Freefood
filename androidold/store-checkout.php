    ...
    <section class="animsition item bg-pink content-part" data-animsition-in-class="fade-in-down-sm" data-animsition-out-class="fade-out-down-sm" data-animsition-in-duration="2000">
                ...
                <div class="col-xs-12 padd-sm text-small" align="center">
                    <ul class="list-group">
                      ...
                      <li class="list-group-item">
                          ...
                          <span class="pull-right"><input type="radio" name="points" value="yes" />
		...
		if($wat1>=$cmn['amount'] && $wat1>0){?>
                <div class="col-xs-12 padd-sm text-small" align="center">
                    <ul class="list-group">
                      <li class="list-group-item list-group-item-success">
                          <span class="pull-left">Special Offer For U</span>
                          <span class="pull-right">&nbsp;</span>
                          <div class="clearfix"></div>
                      </li>
                      <li class="list-group-item">
                          <span class="pull-left"><i class="fa fa-database"></i> <?php echo $wat1; ?></span>
                          <span class="pull-right"><input type="radio" name="points" value="special" />
                          <input type="hidden" name="special_discount" value="<?php echo $wat1;?>" /></span>
                          <div class="clearfix"></div>
                      </li>
                    </ul>
                </div>

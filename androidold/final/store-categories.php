      ...
      <ul class="shop_items sub-cat">
       <?php 
			  ...
			  while($row=mysql_fetch_assoc($qry))
			  {
				?>
				<li>
          <div class="shop_thumb"><a href="shop-items.php?pid=<?php echo $row['guid'];?>"><img src="uploaded_files/<?php echo $row['image'];?>" alt="" title="" /></a></div>
          <div class="shop_item_details">
          <h4><a href="shop-items.php?pid=<?php echo $row['guid'];?>"><?php echo $row['name'];?></a></h4>
          <div class="shop_item_price">
		   <div class="sub-category">
 <?php 
			  $qry_sub=mysql_query("select * from subcategory where refid='".$row['guid']."'  order by name asc") or die('error');
			  while($row_sub=mysql_fetch_assoc($qry_sub))
			  {
				?>
				<a href="shop-items.php?pid=<?php echo $row_sub['guid'];?>"><?php echo $row_sub['name']; ?></a>

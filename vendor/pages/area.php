...
if(isset($_POST) && $_POST[refid]!='' && $_POST[hidid]=='')
{
	...
	if($topic!='' && $refid!='' && $chk['guid']=='')
	{
mysql_query("INSERT INTO `area` (`name` ,`refid`,`food`,`store`,`clp`,`mobile`,`email`,`password`,`address`) VALUES ('$topic','$refid','$food','$store','$clp','$mobile','$email','$password','$address')");
	}
...
{
mysql_query("update `area` set `name`='$topic',`refid`='$refid',`food`='$food',`store`='$store',`clp`='$clp',`mobile`='$mobile',`email`='$email',`password`='$password',`address`='$address' where guid='$hidid'");
header('location:area.php');	
}
?><!DOCTYPE html>
<html>
        ...
        <!-- header logo: style can be found in header.less -->
		 ...
		 <div class="wrapper row-offcanvas row-offcanvas-left">
				...
				echo "<option value='$row[guid]'>$row[name]</option>";  
                    ...
                    <tr><td>Area</td><td>
                      ...
                      <tr><td>CLP Name</td><td>
                        <input type="text" name="clp" class="form-control" placeholder="CLP Name"/>
                    </td></tr>
                    <tr><td>Mobile</td><td>
            ...
            <tr><td>Area</td><td>
                    ...
                    <tr><td>CLP Name</td><td>
                        <input type="text" name="clp" class="form-control" placeholder="CLP Name" value="<?php echo $det['clp'];?>"/>
                    </td></tr>
                    <tr><td>Mobile</td><td>

 ...
 * @version: 0.9.0
 */
define('NICUPLOAD_PATH', '/home/vjsgloba/public_html/admin280971/images/'); // Set the path (relative or absolute) to
                                      // the directory to save image files
define('NICUPLOAD_URI', 'http://www.vjsglobal.com/admin280971/images/');   // Set the URL (relative or absolute) to

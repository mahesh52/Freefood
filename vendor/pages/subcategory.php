...
{
mysql_query("delete from subcategory where guid='$_GET[deleteid]'");
...
mysql_query("INSERT INTO `subcategory` (`name` ,`refid`,`image`) VALUES ('$topic','$refid','$picname')");
	}
...
mysql_query("update `subcategory` set `image`='$picname' where guid='$hidid'");
}
mysql_query("update `subcategory` set `name`='$topic',`refid`='$refid' where guid='$hidid'");
header('location:subcategory.php');	
}
?><!DOCTYPE html>
<html>
        ...
        <!-- header logo: style can be found in header.less -->
		 ...
		 <div class="wrapper row-offcanvas row-offcanvas-left">
            ...
            <aside class="right-side">
				...
				<form action="subcategory.php" method="post" name="form1" onSubmit="return valid()" enctype="multipart/form-data">
			  ...
			  while($row=mysql_fetch_assoc($qry))
			  {
               ...
               <tr><td colspan="2">                                                            
				...
				<?php }elseif(isset($_GET) && $_GET[action]=='edit'){
					$det=mysql_fetch_array(mysql_query("select * from subcategory where guid='$guid'"));?>
				
				<form action="subcategory.php" method="post" name="form1" onSubmit="return valid()">
               <table class="table table-responsive table-bordered">
            ...
            <tr><td>Sub Category</td><td>
               ...
               <input type="hidden" name="hidid" value="<?php echo $det[guid];?>">                                                          
                ...
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="subcategory.php?action=add"><button type="button" class="btn btn-success">Add sub Category</button></a>
...
$query_clients="SELECT * FROM `subcategory`  order by guid desc  Limit $start, $limit ";

$query_clients=mysql_query($query_clients);

$select1="SELECT * FROM `subcategory`";
...
@$divs=$total%$limit;
	...
	@$totals=(int)($total/$limit) + 1;
						    ...
						    while($client_count = mysql_fetch_assoc($query_clients)){
								$det=mysql_fetch_array(mysql_query("select * from storecategory where guid='$client_count[refid]'"));?>
                        	...
                        	<tr>
                               ...
                               <td><a href="subcategory.php?action=edit&guid=<?php echo $client_count[guid]; ?>"><button type="button" class="btn btn-default">Edit</button></a></td>
                                <td><a href="subcategory.php?action=delete&deleteid=<?php echo $client_count[guid]; ?>" onClick="return delete1();"><button type="button" class="btn btn-danger">Delete</button></a></td>

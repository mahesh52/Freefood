...
<p style="color:black;"><b>Please let us know if you are interested, We will get back to you.</b></p>	
			<a href="sev-single-title-pageconfirmdetails.php" class="btn btn-primary active" style="color:white;">I'm Interested </a>
			<br/>
			<br/>
			<a href="partner-with-us-page.php" class="btn btn-primary " style="float:right;">Back</a>
			</div>
</center>
  </div>
